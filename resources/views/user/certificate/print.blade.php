    ...
    <div class="card-header" id="headingOne">
        ...
        <div class="card-body-p">
            ...
            <br>
                ...
                <br>
                <br>
                <span class="text text-md ml-4 pl-5">&nbsp 2. Add: one (1) salary grade increase {{ ($salaryAdjustment->office->office_code == "0031") ? '1 month' : "3 months" }}</span><span class="text col-3 offset-1 float-right">&#8369
